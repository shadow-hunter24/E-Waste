...
const API_BASE_URL = "http://10.158.241.16/E-Waste-MOBILE/backend/public";
...
const mockWasteTypes: WasteType[] = [
  ...
  },
  {
    id: 4,
    name: "Batteries",
    description: "Rechargeable batteries and power banks",
    price_per_unit: 8.0,
    unit: "kg",
    category: "Batteries",
  },
...
const mockRequests: PickupRequest[] = [
  ...
  },
  {
    ...
    status: "ON_ROUTE",
    payment_method: "CASH",
    items: [{ waste_type_id: 2, quantity: 1.3 }],
...
class ApiService {
  ...
  private handleMockRequest<T>(
    ...
    if (endpoint.includes("/auth/forgot-password.php") && method === "POST") {
      ...
      return {
        success: true,
        data: { message: "Password reset email sent" } as T,
      } as ApiResponse<T>;
    }
  ...
  // Pickup Requests
  async createRequest(
    requestData: WasteSubmissionForm,
